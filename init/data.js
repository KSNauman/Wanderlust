...
const updatedListingsWithGeometry = updatedListings.map(listing => {
  // approximate coordinates for locations
  const coordinatesMap = {
    ...
    "Lake Tahoe": [-120.044, 39.0968],
    "Los Angeles": [-118.2437, 34.0522],
    "Verbier": [7.2260, 46.0958],
    "Serengeti National Park": [34.6857, -2.3333],
    "Amsterdam": [4.9041, 52.3676],
    "Fiji": [178.0650, -17.7134],
    "Cotswolds": [-1.7839, 51.8336],
    "Boston": [-71.0589, 42.3601],
    "Bali": [115.1889, -8.4095],
    "Banff": [-115.5723, 51.1784],
    "Miami": [-80.1918, 25.7617],
    "Phuket": [98.3381, 7.8804],
    "Scottish Highlands": [-4.2435, 57.5078],
  ...
  return {
    ...
    geometry: {
      type: "Point",
      coordinates: coordinatesMap[listing.location] || [0, 0], // fallback if location not found
    },
  };
});
